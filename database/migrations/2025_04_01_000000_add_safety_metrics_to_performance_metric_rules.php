...
class AddSafetyMetricsToPerformanceMetricRules extends Migration
{
    public function up()
    {
        Schema::table('performance_metric_rules', function (Blueprint $table) {
            ...
            $table->enum('driver_distraction_gold_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for gold driver distraction');
            $table->decimal('driver_distraction_silver', 5, 2)->nullable()->comment('Threshold for silver driver distraction');
            $table->enum('driver_distraction_silver_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for silver driver distraction');
            $table->decimal('driver_distraction_not_eligible', 5, 2)->nullable()->comment('Threshold for not eligible driver distraction');
            $table->enum('driver_distraction_not_eligible_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for not eligible driver distraction');
            ...
            $table->enum('speeding_violation_gold_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for gold speeding violation');
            $table->decimal('speeding_violation_silver', 5, 2)->nullable()->comment('Threshold for silver speeding violation');
            $table->enum('speeding_violation_silver_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for silver speeding violation');
            $table->decimal('speeding_violation_not_eligible', 5, 2)->nullable()->comment('Threshold for not eligible speeding violation');
            $table->enum('speeding_violation_not_eligible_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for not eligible speeding violation');

            // Sign Violation thresholds
            $table->decimal('sign_violation_gold', 5, 2)->nullable()->comment('Threshold for gold sign violation');
            $table->enum('sign_violation_gold_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for gold sign violation');
            $table->decimal('sign_violation_silver', 5, 2)->nullable()->comment('Threshold for silver sign violation');
            $table->enum('sign_violation_silver_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for silver sign violation');
            $table->decimal('sign_violation_not_eligible', 5, 2)->nullable()->comment('Threshold for not eligible sign violation');
            $table->enum('sign_violation_not_eligible_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for not eligible sign violation');
            ...
            $table->enum('traffic_light_violation_gold_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for gold traffic light violation');
            $table->decimal('traffic_light_violation_silver', 5, 2)->nullable()->comment('Threshold for silver traffic light violation');
            $table->enum('traffic_light_violation_silver_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for silver traffic light violation');
            ...
            $table->enum('traffic_light_violation_not_eligible_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for not eligible traffic light violation');
            ...
            $table->enum('following_distance_gold_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for gold following distance');
            $table->decimal('following_distance_silver', 5, 2)->nullable()->comment('Threshold for silver following distance');
            $table->enum('following_distance_silver_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for silver following distance');
            $table->decimal('following_distance_not_eligible', 5, 2)->nullable()->comment('Threshold for not eligible following distance');
            $table->enum('following_distance_not_eligible_operator', [
                'less',
                'equal',
                'less_or_equal',
                'more_or_equal',
                'more',
            ])->default('equal')->nullable()->comment('Operator for not eligible following distance');
        });
    }
