...
class CreateDelaysTable extends Migration
{
    public function up()
    {
        Schema::create('delays', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tenant_id')->constrained()->cascadeOnDelete()->comment('Tenant associated with the delay');
            ...
            $table->foreignId('delay_code_id')->constrained()->cascadeOnDelete()->comment('References the delay code');
