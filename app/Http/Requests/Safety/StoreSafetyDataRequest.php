...
/**
 * Class StoreSafetyDataRequest
 *
 * Validates data for creating a new safety data entry.
 *
 * Command:
 *   php artisan make:request StoreSafetyDataRequest
 */
class StoreSafetyDataRequest extends FormRequest
{
    ...
    public function rules()
    {
        return array_merge([
            ...
            'seatbelt_compliance', 'camera_obstruction', 'driver_drowsiness', 'weaving', 'weaving_gz_impact', 'swerve',
            'collision_warning', 'collision_warning_gz_impact', 'requested_video', 'backing', 'roadside_parking', 'lane_conduct',
