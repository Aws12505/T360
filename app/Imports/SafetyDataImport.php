...
class SafetyDataImport implements ToCollection, WithStartRow, WithChunkReading, WithBatchInserts
{
    ...
    protected function mapRowToData(Collection $clean, string $rowDate): array
    {
        return [
            ...
            'swerve'                              => $clean[39],
            'collision_warning'                   => $clean[40],
            'collision_warning_gz_impact'         => $clean[41],
            ...
            'driver_star'                         => $clean[49],
            'driver_star_gz_impact'               => $clean[50],
            'vehicle_type'                        => $clean[51],
            'safety_normalisation_factor'         => $clean[52],
            'date'                                => $rowDate,
        ];
    }
